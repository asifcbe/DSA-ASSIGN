...
const findPair = (targetValue, arrayInput = [] ) => {
  ...
  const str2 = "fault";
  const str3 = "revir";
  console.log(str1+" and "+ str2, "is", isSameAfterRotate(str1, str2));
  console.log(str1+" and "+ str3, "is", isSameAfterRotate(str1, str3));
  console.log("------answer ends-------"); 
